      ...
      <div class="flex justify-between h-16 items-center">
        ...
        <div class="flex items-center gap-6">
          <div v-if="authStore.isLoggedIn" class="flex items-center gap-4">
            ...
            <button
              @click="handleLogout"
              class="text-sm font-medium text-slate-500 hover:text-indigo-600 transition-colors flex items-center gap-1 py-2 px-3"
            >
          ...
          <div v-else class="flex items-center gap-3">
            <NuxtLink
              to="/auth/login"
              class="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 transition-colors py-2 px-3"
            >
              Sign in
            </NuxtLink>
            ...
            <NuxtLink
              to="/auth/register"
              class="text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700 px-5 py-2 rounded-lg transition-colors flex items-center gap-2 shadow-sm"
            >
