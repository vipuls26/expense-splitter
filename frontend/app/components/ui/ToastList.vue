  ...
  <div class="fixed top-4 right-4 z-9999 flex flex-col gap-2">
    <TransitionGroup name="toast">
      <div
        ...
        :key="toast.id"
        :class="[
          'px-4 py-3 rounded-lg shadow-sm border flex items-center gap-3 min-w-62.5 max-w-sm transition-all duration-300',
          toast.type === 'success'
        ...
        <i
          :class="[
            ...
            toast.type === 'success'
              ...
              : toast.type === 'error'
                ? 'pi-exclamation-circle text-red-600 dark:text-red-400'
                : toast.type === 'warning'
                  ? 'pi-exclamation-triangle text-amber-600 dark:text-amber-400'
