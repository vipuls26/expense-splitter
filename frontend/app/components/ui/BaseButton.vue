  ...
  <button
    ...
    :class="[
      'font-medium rounded-lg transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2',
      {
        ...
        'px-4 py-2.5': size === 'md',
        'bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-slate-200 text-white dark:text-slate-900': variant === 'solid',
        'bg-red-600 dark:bg-red-500 hover:bg-red-700 dark:hover:bg-red-600 text-white': variant === 'danger',
