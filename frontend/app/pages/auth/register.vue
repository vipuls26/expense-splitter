  ...
  <div class="min-h-screen flex items-center justify-center bg-white p-4">
    <div class="max-w-sm w-full space-y-8">
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        <BaseInput id="name" label="Full Name" v-model="name" icon="pi-user" placeholder="Enter Name" :error="errors.name" required />
        ...
        <BaseInput id="password_confirmation" label="Confirm Password" v-model="password_confirmation" type="password"
          icon="pi-check-circle" placeholder="Enter Confirm Password" :error="errors.password_confirmation" required />

        <BaseInput id="phone_no" label="Phone Number" v-model="phone_no" type="number"
        ...
        <BaseButton type="submit" :is-loading="isLoading" icon="pi-user-plus" loading-text="Creating account..." block>
          Sign up
        </BaseButton>
      </form>
