<template>
  <div class="py-6 phone-lg:py-8 px-4 phone-lg:px-6 tablet:px-8 laptop:px-10">
    ...
    <header class="flex flex-col tablet:flex-row tablet:items-end justify-between gap-4 mb-8 phone-lg:mb-10">
      <div>
        <h1 class="text-2xl phone-lg:text-3xl tablet:text-4xl font-bold text-slate-900 dark:text-slate-100 mb-1">Your Groups</h1>
        <p class="text-sm phone-lg:text-base text-slate-500 dark:text-slate-400">Manage and view all your shared expense groups.</p>
      </div>
